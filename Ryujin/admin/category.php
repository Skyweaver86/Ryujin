...
?>
<?php $page_title = $id ? 'Edit Category' : 'Add Category'; $breadcrumbs = ['Categories' => 'categories.php', ($id ? 'Edit' : 'Add') => null]; ?>
<?php include '../includes/admin-header.php'; ?>

    <form action="category.php?id=<?= $id ?>" method="post" class="form-wrap">
      <div class="page-header"><h1><?= $id ? 'Edit Category' : 'Add Category' ?></h1></div>
